...
const schemas = glob.sync('apollo/modules/**/*.gql')
const resolvers = glob.sync('apollo/modules/**/resolvers.ts').map(withoutExtension)

const out = join('generated', 'modules.ts')
